...
if __name__ == '__main__':
    ...
    generated_desc_dir = '../../resources/descriptions'
    ...
    model = code_bert_utils.build_model(
        model_class=RobertaModel, model_file=model_file, config=config,
    ...
    with tqdm(total=total_examples, file=sys.stdout,
        ...
        for i in range(total_examples):
            ...
            generated_desc, length = code_bert_utils.inference(features_code, model,
